...
def tab_dashboard():
    ...
    # Filtrage Escrow selon la règle métier (case cochée OU honoraires = 0 ET acompte 1 > 0)
    ...
    # Tableau dossiers en Escrow (résumé)
